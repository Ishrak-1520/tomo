    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'var(--bg-color)', color: 'var(--text-main)', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ width: '100%', maxWidth: '400px', padding: '2rem' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)' }}>Log in to continue to Tomo</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '2rem', color: 'var(--text-muted)', fontSize: '0.9rem' }}>
          Don't have an account? <a href="/signup" style={{ color: 'var(--accent-main)', textDecoration: 'none', fontWeight: '600' }}>Sign up</a>
        </p>
      </div>
    </div>
  );
